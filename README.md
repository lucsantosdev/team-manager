...
Imagine something useful, creative, and, of course, charming. Now imagine that I'm still figuring out exactly what that means. Jokes aside, this repository is aiming to become a cool [player and team management system] developed in Python for a project of the Python Fundamentals Course (Module I) from OneBitCode Community.
